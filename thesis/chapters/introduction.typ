...
Astfel, oamenii se confruntă cu tot felul de roboți de acest tip din ce în ce mai mult.
...
În acest context în care se dorește ca soluțiile de automatizare să fie cât mai independente de un operator uman, se remarcă roboții mobili care sunt din ce în ce mai folosiți în tot felul de domenii, de la cele industriale, agriculturale până la uzul de zi cu zi al unui utilizator obișnuit.
Când vine vorba de roboții mobili, indiferent de tipul lor, cel mai important aspect este reprezentat de abilitatea robotului de a se deplasa în siguranță pentru a-și îndeplini sarcinile.
Pentru a se putea realiza orice sarcină, este necesar ca robotul să cunoască mediul înconjurător și să se poată plasa în acesta.

Aceasta este problema consacrată sub numele de SLAM, Simultaneous Localization and Mapping.
Robotul mobil trebuie să cunoască în orice moment de timp cum arată mediul înconjurător.
Astfel se dezvoltă cele 2 probleme care formează o relație de dependență între acestea: localizarea și cartografierea mediului.
...
Fără o astfel de hartă care reprezintă fidel realitatea, robotul nu se poate raporta la aceasta pentru a naviga și pentru a-și determina poziția.
Problemele sunt astfel interconectate și nu se pot rezolva independent.

Cu cât sunt mai adoptați roboții mobili în diferite domenii, crește și nevoia de soluții care să funcționeze eficient în diferite medii și în diferite condiții de funcționare.
Abordările intuitive, precum utilizarea GPS, nu produc rezultate, neavând o acuratețe suficient de mare pentru a se putea depinde doar de acestea.
În plus, semnalul GPS este sensibil la mediul în care se află.
Din această cauză, robotul trebuie ca în principal să fie capabil să se poată localiza doar în baza propriilor senzori de bază.
...
Pornind de la sistemele mai vechi bazate pe filtre probabilistice pentru estimarea poziției, care vin cu o necesitate mare de resurse de calcul sau cele bazate pe scan matching, alinierea a două seturi de puncte, obstacole observate de robot, în vederea obținerii transformării care suprapune cele două seturi, care sunt mai puțin costisitoare dar au limitările proprii și ajungând la clasele moderne de soluții, bazate pe optimizarea grafurilor.
Acestea din urmă aduc multe îmbunătățiri precum capabilitatea de corecție a întregii traiectorii dar pe de altă parte sunt cele mai costisitoare când vine vorba de resurse.

Cu acestea în vedere a fost dezvoltat un sistem SLAM care vizează să adreseze cât mai bine problemele descrise.
S-a dezvoltat un sistem bazat pe scan matching, care se folosește de un senzor de LiDAR pentru detectarea obstacolelor din mediu și de senzorii odometrici ai roților și de unitatea inerțială a robotului pentru estimarea poziției și, ulterior, realizarea hărții.

În vederea evaluării soluției, s-a urmărit cuantificarea erorii între traiectoria estimată, reprezentată de pozițiile estimate de către sistem, și traiectoria reală, de referință pentru a aprecia cât de precisă este componenta de localizare, folosind două metrici: ATE și RPE, care urmăresc precizia globală, respectiv locală a traiectoriei.
...
În acest context, contribuția principală constă în realizarea unui sistem SLAM bidimensional bazat pe scan matching care este capabil să estimeze traiectoria robotului cu o eroare de sub 0.1% din lungimea acesteia și să reprezinte corect mediul înconjurător, cu o robustețe bună la caracteristicile mai puțin ideale ale mediului.

În continuare, lucrarea este structurată în alte șase capitole.
Al doilea capitol prezintă fundamentele teoretice ale lucrării necesare familiarizării și înțelegerii.
Se vor introduce conceptele de bază de SLAM, unele tipologii de soluții existente, precum și o scurtă explorare a soluțiilor consacrate specifice LiDAR SLAM-ului.
...
Capitolul al treilea ilustrează arhitectura abstractă a sistemului și componentele principale ale soluției, precum și comunicarea între componentele deja prezentate.
...
Al cincilea capitol prezintă structura experimentului, mediile de testare și rezultatele obținute, dar și o analiză sumară a acestora.
Al șaselea capitol prezintă discuțiile pe baza rezultatelor obținute precum și o analiză a limitărilor, dar și a posibilelor direcții de dezvoltare viitoare.
Nu în ultimul rând, în cel de-al șaptelea capitol sunt prezentate concluziile trase în urma dezvoltării soluției.